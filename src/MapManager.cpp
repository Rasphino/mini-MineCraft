...
void MapManager::genFlower(int cx, int cz) {
    ...
    std::string insertQuery = "replace into block" + std::to_string(cacheMap[cx][cz]) + " values ";
    int i = 0;
...
uint64_t getID(int x, int z) { return getID(getChunkVertex(x, z)); }
